...
class CreateDanhMucRequest extends FormRequest
{
    ...
    {
        return [
            'ma_danh_muc' => 'required|min:2|unique:danh_mucs,ma_danh_muc',
            'ten_danh_muc'=> 'required|min:1|unique:danh_mucs,ten_danh_muc',
            'slug_danh_muc'=> 'required|min:1|unique:danh_mucs,slug_danh_muc',
            'is_open' =>'required',
