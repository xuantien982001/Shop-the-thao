    ...
    <div class="header-wrapper row m-0">
        ...
        <div class="header-logo-wrapper col-auto p-0">
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid"
                        src="/assets_UI/assets_admin/images/logo/logo.png" alt=""></a></div>
        ...
        <script class="empty-template" type="text/x-handlebars-template"><div class="EmptyMessage">© 2022 Được Tạo Bởi Nhóm Đồ Án Chuyên Ngành: Tích Hợp Hệ Thống (COTS) </div></script>
    </div>
</div>
